...
//
public class NotifierDialogBackup {
//
...
//			NotificationType type, Display display) throws IOException {
...
//
//		InputStream icon = NotifierDialogBackup.class.getResource("icon.png")
//				.openStream();
