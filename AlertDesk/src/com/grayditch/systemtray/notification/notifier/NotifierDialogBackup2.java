...
public class NotifierDialogBackup2 {
	...
	private static Color _titleFgColor = ColorCache.getColor(201, 201, 201);
	// text foreground color
	private static Color _fgColor = ColorCache.getColor(240, 243, 244);
	...
	public static void notify(String title, String message,
			String imageDisplay, final Display display) throws IOException {
		...
		InputStream icon = NotifierDialogBackup2.class.getResource("icon.png")
				.openStream();
		...
		_shell.addListener(SWT.Resize, new Listener() {
			...
			public void handleEvent(Event e) {
				try {
					...
					// NotifierDialog.class.getResource("icon.png")
					// .openStream()));
		...
		imgLabel.setImage(new Image(display, NotifierDialogBackup2.class.getResource(
